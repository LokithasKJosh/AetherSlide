...
const introPitchDeckSchema = z.object({
  ...
  companyName: z.string().default("1+TECH").meta({
        ...
        <div className="absolute bottom-8 left-10 right-10 flex flex-wrap items-center gap-10 text-[#1E4CD9] text-sm font-medium">
          {contactNumber && (
            <div className="flex items-center gap-2">
              <span className="text-lg">馃摓</span>
              <span>{contactNumber}</span>
            </div>
          )}
          {contactAddress && (
            <div className="flex items-center gap-2">
              <span className="text-lg">馃搷</span>
              <span>{contactAddress}</span>
            </div>
          )}
          {contactWebsite && (
            <div className="flex items-center gap-2">
              <span className="text-lg">馃寪</span>
              <span>{contactWebsite}</span>
            </div>
          )}
          {description && (
            <div className="flex items-center gap-2">
              <span className="text-lg">馃挰</span>
